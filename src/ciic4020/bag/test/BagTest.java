...
public class BagTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("The element(s) more frequent than Bob are:");
		printBag(theBag.moreFrequentThan("Bob"));
		
		System.out.println("The element(s) more frequent than Jil are:");
		printBag(theBag.moreFrequentThan("Jil"));
		
		System.out.println("The element(s) more frequent than Ned are:");
		printBag(theBag.moreFrequentThan("Ned"));
