...
public class SetTest {
	...
	public static void main(String[] args) {
		...
		Set<String> mySet1 = input.equals("S") ? new StaticSet<String>(10) : new DynamicSet<String>(10);
		mySet1.add("Amy");
		mySet1.add("Jil");
		mySet1.add("Moe");
		mySet1.add("Ned");
		
		Set<String> mySet2 = input.equals("S") ? new StaticSet<String>(10) : new DynamicSet<String>(10);
		mySet2.add("Amy");
		mySet2.add("Jil");
		mySet2.add("Moe");
		mySet2.add("Ned");
		...
		System.out.println("Is mySet1 equal to mySet2?: " + mySet1.equals(mySet2));
